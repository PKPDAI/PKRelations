...
def test_entity_matcher():
    ...
    assert doc2_ents == [('geometric mean', 'TYPE_MEAS'), ('AUC24,ss', 'PK'), ('21', 'VALUE'), ('%', 'UNITS'),
                         ('28', 'VALUE'), ('%', 'UNITS'), ('=', 'COMPARE'), ('=', 'COMPARE'), ('63', 'VALUE'),
                         ('931', 'VALUE'), ('95%-CI', 'TYPE_MEAS'), ('676–1283', 'RANGE'), ('1177', 'VALUE'),
                         ('95%-CI', 'TYPE_MEAS'), ('1097–1263', 'RANGE'), ('<', 'COMPARE'), ('0.05', 'P-VALUE'),
                         ('354', 'VALUE'), ('95%-CI', 'TYPE_MEAS'), ('174–720', 'RANGE'), ('492', 'VALUE'),
                         ('95%-CI', 'TYPE_MEAS'), ('435–555', 'RANGE'), ('<', 'COMPARE'), ('0.05', 'P-VALUE')]


EXAMPLE_PVALUE = "The clearance was 54.453 and the p-value < 0.01. The pval was 0.01 . This is true (p>0.01). " \
                 "p-val=0.9, p=10 (P > 0.1)"


def test_p_values():
    doc = NER_MODEL(EXAMPLE_PVALUE)
    doc_ents = [(ent.text, ent.label_) for ent in doc.ents]
    assert doc_ents == [('clearance', 'PK'), ('54.453', 'VALUE'), ('<', 'COMPARE'), ('0.01', 'P-VALUE'),
                        ('0.01', 'P-VALUE'), ('>', 'COMPARE'), ('0.01', 'P-VALUE'), ('=', 'COMPARE'),
                        ('0.9', 'P-VALUE'), ('=', 'COMPARE'), ('10', 'VALUE'), ('>', 'COMPARE'), ('0.1', 'P-VALUE')]
