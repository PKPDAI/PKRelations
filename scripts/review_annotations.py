...
def run(azure_file_name: str, out_dir: str):
    ...
    print("PRODIGY_PORT=8001 prodigy custom.rel.manual {} data/models/tokenizers/rex-tokenizer {} --label C_VAL,"
