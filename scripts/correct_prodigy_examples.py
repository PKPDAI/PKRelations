...
def main(
        ...
        base_file: str = typer.Option(default="data/annotations/P1/ready/test-all-ready-fixed-3.jsonl",
                                      help="Local output directory to save the model and files"),
        new_dataset_name: str = typer.Option(default="test-all-ready-fixed-5",
                                             help="Whether to save the model to azure"),
        hash_list: List[int] = typer.Option(default=[-753286700],
